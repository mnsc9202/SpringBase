...
public interface PostService {
	 ...
	 * @return Boolean 게시글 저장 여부
	 */
	Boolean savePost(PostRequestDto requestDto);
	 ...
	 * @return Boolean 게시글 수정 여부
	 */
	Boolean updatePost(PostRequestDto requestDto);
	 ...
	 */
	Boolean deletePost(Integer seq);
	 ...
	 */
	Boolean increaseReadCount(Integer seq);
}
